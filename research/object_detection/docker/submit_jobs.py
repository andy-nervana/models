...
if __name__ == '__main__':
    ...
    train_cmd = 'python /home/models/research/object_detection/train_script.py /home/models/research/object_detection/train_args2.txt '
    model_dir = '/workspace/'
    ...
    #models = ['01_ssd_mobilenet_v2_coco_cotafix_lr015_dr05_ds20k_512_foc_a010_g500',
             #'02_ssd_mobilenet_v2_coco_cotafix_lr050_dr05_ds30k_512_foc_a025_b200',
              #'03_ssd_mobilenet_v2_coco_cotafix_lr050_dr05_ds30k_512_foc_a075_b200',
              #'04_ssd_mobilenet_v2_coco_cotafix_adam_lr050_dr05_ds30k_512',
              #'05_ssd_mobilenet_v2_coco_cotafix_lr050_dr05_ds30k_512']

    models = ['07_ssd_mobilenet_v2_coco_cotafix_lr050_dr05_ds30k_512_NOSIGMOID',
              '08_ssd_mobilenet_v2_coco_cotafix_lr050_dr05_ds30k_512_foc_a025_b200_NOSIGMOID',
              '09_ssd_mobilenet_v2_coco_cotafix_lr015_dr05_ds100k_1080_foc_a025_b200_NOSIGMOID',
              '10_ssd_mobilenet_v2_coco_cotafix_lr050_dr05_ds50k_512_NOSIGMOID',
              '11_ssd_mobilenet_v2_coco_cotafix_lr050_dr05_ds50k_512_foc_a025_b200_NOSIGMOID',
              '12_ssd_mobilenet_v2_coco_cotafix_lr050_dr05_ds50k_512']
